    ...
    <div>
      ...
      <div className="mt-5 text-left px-6">
        <h1 className="text-2xl font-bold">
          Privacy Policy for Arit Developer, LLC
        </h1>
        ...
        <p>
          ...
          contact us through email at Email@Website.com This privacy policy
          ...
          collect in FindYourPeople. This policy is not applicable to any
          information collected offline or via channels other than this website
        </p>
        <h3 className="text-xl py-3 font-semibold">Consent</h3>
        <p>
          By using our website, you hereby consent to our Privacy Policy and
          agree to its terms.
        </p>
        <h3 className="text-xl py-3 font-semibold">Information we collect</h3>
        <p>
        ...
        <h3 className="text-xl py-3 font-semibold">Log Files</h3>
        <p>
          FindYourPeople follows a standard procedure of using log files. These
        ...
        <h3 className="text-xl py-3 font-semibold">Cookies and Web Beacons</h3>
        <p>
          Like any other website, FindYourPeople uses cookies. These cookies are
        ...
        <h3 className="text-xl py-3 font-semibold">DoubleClick DART Cookie</h3>
        <p>
        ...
        <p>
          FindYourPeople Privacy Policy does not apply to other advertisers or
        ...
        <p>
          ...
          right to: Request that a business that collects a consumers personal
          ...
          collected. Request that a business that sells a consumers personal
          data, not sell the consumers personal data. If you make a request, we
          have one month to respond to you. If you would like to exercise any of
          these rights, please contact us.
        </p>
        <h3 className="text-xl py-3 font-semibold">
          GDPR Privacy Policy (Data Protection Rights)s
        </h3>
        <p>
        ...
        <h3 className="text-xl py-3 font-semibold">Childrens Information</h3>
        <p>
